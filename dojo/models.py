...
class Ninja(models.Model):
    ...
    cellphone = models.CharField('Cellulare', max_length=15, null=True, blank=True)
    ...
    parentcellphone = models.CharField('Cell Genitore', max_length=15, null=True, blank=True)
