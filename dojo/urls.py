...
urlpatterns = patterns('',
    ...
    url(r'^ninja/delete/(?P<pk>\d+)/$', permission_required('dojo.delete_ninja', raise_exception=True)(views.Ninja_delete.as_view()), name="ninja_delete"),
    ...
    url(r'^mentor/delete/(?P<pk>\d+)/$', permission_required('dojo.delete_mentor', raise_exception=True)(views.Mentor_delete.as_view()), name="mentor_delete"),
